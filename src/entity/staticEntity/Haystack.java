...
public class Haystack extends StaticEntity {
    ...
    public Haystack (Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.world1_Entities[1][5], (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), objectWidth, objectHeight, null);
        // Draw hitbox
