...
public class Boat2 extends StaticEntity{
    ...
    public Boat2(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.world2_Entities[1][1], (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), objectWidth, objectHeight, null);
        // Draw hitbox
