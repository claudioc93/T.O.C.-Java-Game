 ...
 */
public class WorriorW extends Player{
  ...
  //COSTRUTTORE
  public WorriorW(Handler handler,float x, float y) {   
    ...
    anim= new PlayerAnimation(handler,60,120,100,Assets.WarriorWomananimation,Assets.WarriorWoman_animationAtk, Assets.WarriorWoman_animationDeath);
  }
